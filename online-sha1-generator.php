...
if(isset($_POST['encode_url'])){
    ...
    $encodedUrl = sha1($plainUrl);
}

?>
<h1>Online sha1() generator </h1>
<div class="row" style="margin-bottom: 10px;">
    <form class="form-horizontal" id="sha-gen" role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
        ...
        <div class = "form-group">
            <div class = "col-sm-offset-2 col-sm-6">
                <button type="submit" class="btn btn-default pull-left" name="encode_url">Make sha1 </button>
            </div>
        </div> 
    </form>
    <div class = "form-group">
